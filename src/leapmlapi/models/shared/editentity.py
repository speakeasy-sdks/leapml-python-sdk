...
class EditEntity:
    ...
    image_guidance_scale: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('imageGuidanceScale') }})
    ...
    text_guidance_scale: float = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('textGuidanceScale') }})
