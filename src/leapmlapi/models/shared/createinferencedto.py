...
class CreateInferenceDtoSampler(str, Enum):
...
class CreateInferenceDtoUpscaleBy(str, Enum):
...
class CreateInferenceDto:
    ...
    sampler: Optional[CreateInferenceDtoSampler] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('sampler'), 'exclude': lambda f: f is None }})
    r"""Choose the sampler used for your inference."""
    ...
    upscale_by: Optional[CreateInferenceDtoUpscaleBy] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('upscaleBy'), 'exclude': lambda f: f is None }})
    r"""Optionally upscale the generated images. This will make the images look more realistic. The default is x1, which means no upscaling. The maximum is x4."""
